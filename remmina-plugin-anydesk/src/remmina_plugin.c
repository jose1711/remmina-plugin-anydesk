...
/* Initialize plugin */
static void remmina_plugin_anydesk_init(RemminaProtocolWidget *gp) {
  TRACE_CALL(__func__);
...
/* Open connection */
static gboolean remmina_plugin_anydesk_open_connection(RemminaProtocolWidget *gp) {
  TRACE_CALL(__func__);
  ...
  remmina_plugin_service->log_printf("[ANYDESK] starting %s\n", command_line);
  g_free(command_line);
  // Execute the external process rdesktop
  ret = g_spawn_async(NULL, argv, NULL, G_SPAWN_SEARCH_PATH, NULL, NULL, &gpdata->pid, &error);
  remmina_plugin_service->log_printf("[ANYDESK] started anydesk with GPid %d\n", &gpdata->pid);
...
/* Close connection */
static gboolean remmina_plugin_anydesk_close_connection(RemminaProtocolWidget *gp) {
  TRACE_CALL(__func__);
 ...
 * f) Setting tooltip
 */
static const RemminaProtocolSetting remmina_plugin_anydesk_basic_settings[] = {
...
static RemminaProtocolPlugin remmina_plugin = {
  ...
  remmina_plugin_anydesk_basic_settings,     // Array for basic settings
  NULL,                                         // Array for advanced settings
  REMMINA_PROTOCOL_SSH_SETTING_NONE,            // SSH settings type
  NULL,                                         // Array for available features
  remmina_plugin_anydesk_init,               // Plugin initialization
  remmina_plugin_anydesk_open_connection,    // Plugin open connection
  remmina_plugin_anydesk_close_connection,   // Plugin close connection
